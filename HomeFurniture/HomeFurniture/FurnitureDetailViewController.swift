...
class FurnitureDetailViewController: UIViewController, UIImagePickerControllerDelegate & UINavigationControllerDelegate {
    ...
    @IBAction func choosePhotoButtonTapped(_ sender: Any) {let imagePicker = UIImagePickerController()
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        if let image = info[.originalImage] as? UIImage {
            ...
            furniture?.imageData = jpegData
                // Update your UI or model as needed here
            }
    ...
    @IBAction func actionButtonTapped(_ sender: Any) {
        guard let image = photoImageView.image , let description = furnitureDescriptionLabel.text
                else {
                    return
                }
