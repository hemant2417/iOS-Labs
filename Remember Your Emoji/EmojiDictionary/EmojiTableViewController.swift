...
class EmojiTableViewController: UITableViewController {
    ...
    @IBSegueAction func addEditEmoji(_ coder: NSCoder, sender: Any?) -> EditTableViewController? {
        ...
        return EditTableViewController(coder: coder, emoji: emojis[indexPath.row])
    }    
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.updateUI(with: emojis[indexPath.row])
    ...
    @IBAction func unwindToEmojiTVC(segue: UIStoryboardSegue) {
        guard segue.identifier == "saveSegue", let addEditTVC = segue.source as? EditTableViewController, let emoji = addEditTVC.emoji else { return }
